...
> [!TIP]
> **画像認識（AI）を使いこなすコツ**
> 図面上の「キッチンのLR勝手」などをAIに判定させる際、単純な記号パターンだけでは上下左右があべこべに誤認識されることがあります。これを防ぐには「キッチン」などの文字の向きを基準としてAIに指示することが極めて有効です。詳細はチェックリスト内のコラム「💡 開発・運用者からのメッセージ」をご参照ください。何往復かの調整を繰り返しながら、気長に育てていきましょう。
